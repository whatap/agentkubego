...
// 20170927 PanicHandler로 변경 프로세스 중지안되도록
var ErrorHandler ErrorHandlerFunc = PanicHandler

type LogHandlerFunc func(id string, fmt string, args ...interface{})

var LogPrintf LogHandlerFunc = logutil.Printf
